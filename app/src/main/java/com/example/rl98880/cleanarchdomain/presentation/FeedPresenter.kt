...
import com.example.rl98880.cleanarchdomain.domain.usecase.GetPostsUseCase
import com.example.rl98880.cleanarchdomain.domain.usecase.LikePostUseCase
            ...
            .subscribe(object :
                ...
                override fun onNextFailed(l: GetPostsUseCase.Error) {
                    val error = when (l) {
                        ...
                        GetPostsUseCase.Error.PostNotFetched -> TODO()
                    }
                    showFetchPostError()
                }
