...
import com.example.rl98880.cleanarchdomain.domain.services.ValidationService
...
class LoginUseCaseTest {
    ...
    fun buildUseCase_email_not_valid() {
        ...
        Mockito.`when`(authenticationServiceMock.login(Mockito.any()))
            .thenReturn(Single.just(com.example.rl98880.cleanarchdomain.rxerror.Success(token)))
